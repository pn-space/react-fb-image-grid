...
class Images extends Component {
      ...
      <Grid>
        <Row>
          <Col
            xs={12}
            md={12}
            className={`pierreneter-react-fb-image-grid-border pierreneter-react-fb-image-grid-height-one pierreneter-react-fb-image-grid-background`}
      ...
      <Grid>
        <Row>
          <Col
            xs={6}
            md={6}
            className="pierreneter-react-fb-image-grid-border pierreneter-react-fb-image-grid-height-two pierreneter-react-fb-image-grid-background"
      ...
      <Grid>
        <Row>
          <Col
            xs={6}
            md={4}
            className="pierreneter-react-fb-image-grid-border pierreneter-react-fb-image-grid-height-three pierreneter-react-fb-image-grid-background"
  ...
  renderOverlay(id) {
    ...
    return [
      <div
        key={`cover-${id}`}
        className="pierreneter-react-fb-image-grid-cover pierreneter-react-fb-image-grid-slide"
        style={{ backgroundColor: overlayBackgroundColor }}
      ></div>,
      <div
        key={`cover-text-${id}`}
        className="pierreneter-react-fb-image-grid-cover-text pierreneter-react-fb-image-grid-slide pierreneter-react-fb-image-grid-animate-text"
        style={{ fontSize: "100%" }}
      >
        {renderOverlay()}
      </div>,
  ...
  renderCountOverlay(more) {
    ...
    return [
      more && (
        <div
          key="count"
          className="cpierreneter-react-fb-image-grid-over"
        ></div>
      ),
      more && (
        <div
          key="count-sub"
          className="pierreneter-react-fb-image-grid-cover-text"
          style={{ fontSize: "200%" }}
        >
          <p>+{extra}</p>
        </div>
  ...
  render() {
    ...
    return (
      <div className="pierreneter-react-fb-image-grid-grid-container">
